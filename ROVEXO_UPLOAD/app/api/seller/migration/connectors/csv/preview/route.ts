...
import { previewCsvContent } from "@/lib/seller/migration/connectors/file/csv-parser";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const preview = previewCsvContent(body.fileContent, body.limit ?? 5, body.mapping);
