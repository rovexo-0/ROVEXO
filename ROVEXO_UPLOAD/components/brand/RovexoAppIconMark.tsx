...
export function RovexoAppIconMark({ className, uid = "rx" }: RovexoAppIconMarkProps) {
  const bg = `${uid}-bg`;
  const r = `${uid}-r`;
  ...
  return (
    <svg viewBox="0 0 1024 1024" className={cn("shrink-0", className)} aria-hidden fill="none">
      <defs>
