...
export function AuthShell({ children, className }: AuthShellProps) {
  return (
    <div
      className={cn(
        "relative flex min-h-[100dvh] flex-col items-center justify-center overflow-hidden rx-page bg-background px-ds-4",
    ...
    >
      ...
      />
      <MotionDiv className="rx-surface-card rx-depth-3 relative z-10 w-full max-w-[420px] rounded-ds-2xl p-ds-6 sm:p-ds-8">
        {children}
      </MotionDiv>
    </div>
  );
