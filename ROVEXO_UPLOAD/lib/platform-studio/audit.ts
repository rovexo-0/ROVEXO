...
export async function auditPlatformStudioAction(input: {
  actorId: string;
  module: string;
  action: string;
  ...
  await auditSuperAdminAction({
    ...
    action: "platform_studio.change",
    resourceType: "platform_studio",
...
export function createPlatformStudioAuditEntry(input: {
