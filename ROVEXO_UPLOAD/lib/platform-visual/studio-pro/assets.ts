...
export const STUDIO_ASSET_LIBRARY: StudioAssetItem[] = [
  ...
  { id: "cat-vehicles", name: "Vehicles Icon", format: "webp", src: "/categories/vehicles/vehicles-160.webp", folder: "Categories", tags: ["category", "3d"], favorite: true },
  { id: "cat-electronics", name: "Electronics Icon", format: "webp", src: "/categories/electronics/electronics-160.webp", folder: "Categories", tags: ["category", "3d"], favorite: false },
