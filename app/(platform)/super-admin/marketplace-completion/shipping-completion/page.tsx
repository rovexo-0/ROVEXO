...
const props = { tab: "shipping-completion" as const, title: "Shipping Completion", description: "Prompt 085 — Launch Priority #11. OMEGA scans shipping labels, carriers, tracking, zones, returns and purchase protection logistics." };
