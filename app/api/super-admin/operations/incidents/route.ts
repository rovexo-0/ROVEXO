...
import { getOperationsIncidentsData } from "@/lib/operations-center-engine/reader";
...
export async function GET() {
  ...
  return NextResponse.json(await getOperationsIncidentsData());
}
...
export async function POST(request: Request) {
  ...
  try {
    ...
    if (body.action === "create") {
      ...
      const incident = await createOperationsIncident(
        {
          title: body.title,
    ...
    const incident = await updateOperationsIncident(
      body.incidentId,
