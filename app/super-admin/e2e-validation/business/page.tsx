...
const props = { tab: "business" as const, title: "Business Rule Validation", description: "Marketplace rules, trust score, buyer protection, wallet, payments, shipping, and compliance." };
