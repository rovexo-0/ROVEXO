...
const props = { tab: "checkout-completion" as const, title: "Checkout Completion", description: "Prompt 082 — Launch Priority #8. OMEGA scans cart, checkout, payment, order, invoice and purchase protection certification." };
