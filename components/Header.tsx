...
import { MessagesMenuIcon } from "@/features/profile/icons";
...
export function NotificationBell({ unreadCount }: { unreadCount: number }) {
  ...
  return (
    ...
    >
      ...
      {hasUnread && (
        <span
          className="absolute right-1.5 top-1.5 flex min-h-[0.625rem] min-w-[0.625rem] items-center justify-center rounded-ds-full bg-danger px-[0.1875rem] text-[0.625rem] font-semibold leading-none text-danger-foreground ring-2 ring-background"
          aria-hidden
        >
...
function HeaderCategories() {
  ...
  return (
    <nav aria-label="Browse categories" className="border-t border-border">
      <div className="overflow-x-auto px-ds-4 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
...
export default function Header({ isSeller, unreadNotifications = 0 }: HeaderProps) {
