...
type RovexoMobileHeaderScrollContextValue = {
  isVisible: boolean;
  headerHeight: number;
  registerHeader: (element: HTMLElement | null) => void;
};

const RovexoMobileHeaderScrollContext = createContext<RovexoMobileHeaderScrollContextValue | null>(null);

export function useRovexoMobileHeaderScrollContext() {
...
export function RovexoMobileHeaderScrollProvider({ children }: { children: ReactNode }) {
  ...
  const contextValue = useMemo(
    () => ({ isVisible, headerHeight, registerHeader }),
