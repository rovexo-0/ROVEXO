...
import { AllListingsCard } from "@/components/premium/AllListingsCard";
import { AllListingsGrid } from "@/components/premium/AllListingsGrid";
import gridStyles from "@/components/premium/AllListingsGrid.module.css";
import { useMarketplaceFeedColumns } from "@/components/premium/hooks/useMarketplaceFeedColumns";
import { useVirtualizedFeedWindow } from "@/components/premium/hooks/useVirtualizedFeedWindow";
import { HOMEPAGE_DEMO_PRODUCTS } from "@/lib/homepage/demo-data";
import type { Product, ProductsPage } from "@/lib/products/types";

type AllListingsSectionProps = {
...
export const AllListingsSection = memo(function AllListingsSection({
  initialPage,
}: AllListingsSectionProps) {
  ...
  return (
    <section aria-labelledby="all-listings-heading" className="home-v1-listing-section home-v1-all-listings">
      ...
      <AllListingsGrid ref={gridRef}>
        {items.map((product, index) => (
          <Fragment key={product.id}>
            <AllListingsCard product={product} />
