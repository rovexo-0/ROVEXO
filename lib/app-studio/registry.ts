...
export const APP_STUDIO_MODULES: AppStudioPlatformModule[] = [
  ...
  { id: "categories", label: "Categories", icon: "📁", category: "design", href: "/super-admin/categories", status: "live", version: "1.0", health: "healthy", performanceScore: 99, permissions: ["read", "write"], dependencies: ["search"] },
