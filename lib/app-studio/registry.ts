...
export const APP_STUDIO_MODULES: AppStudioPlatformModule[] = [
  ...
  { id: "protection", label: "Purchase Protection Engine", icon: "🛡️", category: "commerce", href: "/super-admin/protection-engine", status: "live", version: "1.0", health: "healthy", performanceScore: 96, permissions: ["read", "moderate"], dependencies: ["orders", "payments"] },
