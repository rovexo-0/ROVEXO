...
export const AUCTION_CATEGORIES: AuctionCategory[] = [
  ...
  { id: "home-garden", name: "Home & Garden", slug: "home-garden", icon: "home-garden" },
  { id: "collectibles", name: "Collectibles", slug: "collectables", icon: "collectibles" },
  { id: "property", name: "Property", slug: "property", icon: "property" },
  { id: "business", name: "Business Equipment", slug: "business", icon: "business" },
  { id: "diy", name: "DIY & Tools", slug: "diy", icon: "diy" },
  { id: "sports", name: "Sports", slug: "sports", icon: "sports" },
  { id: "music", name: "Music", slug: "music", icon: "electronics" },
  { id: "baby", name: "Baby", slug: "baby", icon: "kids" },
