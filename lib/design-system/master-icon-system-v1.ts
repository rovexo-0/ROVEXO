...
export const SELL_FIELD_ICONS = {
  ...
  quantity: { icon: "inventory" as AccountIconName, color: MASTER_ICON_COLORS.blue },
  stock: { icon: "inventory" as AccountIconName, color: MASTER_ICON_COLORS.blue },
  style: { icon: "listings" as AccountIconName, color: MASTER_ICON_COLORS.purple },
  pattern: { icon: "product" as AccountIconName, color: MASTER_ICON_COLORS.magenta },
