...
export function canPerformLaunchReadinessAction(input: { action: string; mfaVerified?: boolean }) {
...
export function requiresMfaForLaunchReadiness(action: string): boolean {
