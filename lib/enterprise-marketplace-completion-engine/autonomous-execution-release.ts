...
function buildReleaseGates(scan: MarketplaceCompletionScanResult, criticalDefects: number): ReleaseGateResult[] {
  const mapping: Record<(typeof RELEASE_GATES)[number], boolean> = {
    ...
    "homepage-complete": scan.homepagePass && fileExists("app/(platform)/page.tsx"),
    "search-complete": fileExists("app/(platform)/search/page.tsx"),
    "listing-publish-complete": fileExists("app/(platform)/sell/page.tsx"),
    "checkout-complete": fileExists("app/(platform)/checkout/[slug]/page.tsx"),
    "payments-complete": fileExists("app/(platform)/account/payment-methods/page.tsx"),
