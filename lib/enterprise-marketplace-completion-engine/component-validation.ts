...
const COMPONENT_REFS: Partial<Record<(typeof GLOBAL_COMPONENT_TYPES)[number], string>> = {
  ...
  widget: "components/homepage/canonical/CanonicalCategoryRail.tsx",
  ...
  banner: "components/homepage/canonical/CanonicalHomepage.tsx",
  category: "components/homepage/canonical/CanonicalCategoryRail.tsx",
