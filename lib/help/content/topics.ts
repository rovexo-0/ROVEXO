...
export const TOPIC_SEEDS: TopicSeed[] = [
  ...
  { slug: "verification", label: "Verification", description: "Identity and payout verification", icon: "✅", group: "Trust & Safety", keywords: ["verify", "identity", "kyc"] },
  ...
  { slug: "business-directory", label: "Directory", description: "Directory help (not active in v1.0 public)", icon: "📇", group: "Help", keywords: ["directory", "company list"] },
  { slug: "company-profiles", label: "Company Profiles", description: "Company pages help (not active in v1.0 public)", icon: "🏛️", group: "Help", keywords: ["company profile", "storefront"] },
  { slug: "request-quote", label: "Request Quote", description: "Quote requests (not active in v1.0 public)", icon: "📝", group: "Help", keywords: ["quote", "rfq", "request quote"] },
