...
ROVEXO is a UK marketplace where every Personal Account can buy and sell. Payments are processed through Stripe. Seller payouts are managed through the ROVEXO Wallet (Balance).`;
