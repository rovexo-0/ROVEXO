...
const EXACT_BACK_ROUTES: Record<string, BackRouteConfig> = {
  ...
  "/seller/wallet": { parentHref: "/balance", label: "Balance" },
  ...
  "/balance": { parentHref: "/account", label: "My Account" },
  ...
  "/account/edit-profile": { parentHref: "/account", label: "Account" },
  "/account/profile/bio": { parentHref: "/account", label: "Account" },
  "/account/profile/avatar": { parentHref: "/account", label: "Account" },
  "/account/addresses": { parentHref: "/account/settings", label: "Settings" },
  "/wallet/payment-methods": { parentHref: "/balance", label: "Balance" },
  "/wallet/bank-accounts": { parentHref: "/balance", label: "Balance" },
  "/wallet/bank-account": { parentHref: "/balance", label: "Balance" },
  "/wallet/pending": { parentHref: "/balance", label: "Balance" },
  "/wallet/processing": { parentHref: "/balance", label: "Balance" },
  "/wallet/locked": { parentHref: "/balance", label: "Balance" },
  "/wallet/payouts": { parentHref: "/balance", label: "Balance" },
  "/wallet/withdraw": { parentHref: "/balance", label: "Balance" },
  "/wallet/transactions": { parentHref: "/balance", label: "Balance" },
  "/wallet/statements": { parentHref: "/balance", label: "Balance" },
  "/account/payment-methods": { parentHref: "/balance", label: "Balance" },
