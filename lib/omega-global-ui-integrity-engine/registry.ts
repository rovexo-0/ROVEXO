...
export const GLOBAL_SCREEN_REGISTRY = [
  ...
  { id: "orders", domain: "marketplace", label: "Orders", route: "/account/orders", componentRef: "OrdersPage" },
  ...
  { id: "messages", domain: "buyer", label: "Messages", route: "/inbox", componentRef: "InboxPage" },
  { id: "notifications", domain: "buyer", label: "Notifications", route: "/inbox?tab=notifications", componentRef: "InboxPage" },
  { id: "saved", domain: "buyer", label: "Saved", route: "/saved", componentRef: "SavedItemsV1" },
  ...
  { id: "seller-dashboard", domain: "seller", label: "Seller Dashboard", route: "/seller", componentRef: "AccountCenterModulePage" },
  { id: "seller-listings", domain: "seller", label: "Seller Listings", route: "/seller/listings", componentRef: "SellerListingsV1" },
