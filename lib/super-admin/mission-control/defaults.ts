...
export function createDefaultHomepageBuilderConfig(): HomepageBuilderConfig {
  const components: HomepageBuilderConfig["components"] = [
    ...
    { id: "category-rail", label: "Category Rail", enabled: true, published: true, order: 2, visibility: { desktop: true, tablet: true, mobile: true }, style: { gap: 12, iconSize: 80 } },
    { id: "hero-slider", label: "Hero Slider", enabled: true, published: true, order: 3, visibility: { desktop: true, tablet: true, mobile: true }, style: { height: 360, borderRadius: 24 } },
    { id: "featured-listings", label: "Featured Listings", enabled: true, published: true, order: 4, visibility: { desktop: true, tablet: true, mobile: true }, style: { columns: 5, gap: 16 } },
    { id: "recommended", label: "Recommended", enabled: true, published: true, order: 5, visibility: { desktop: true, tablet: true, mobile: true }, style: { columns: 4, gap: 16 } },
    { id: "recently-listed", label: "Recently Listed", enabled: true, published: true, order: 6, visibility: { desktop: true, tablet: true, mobile: true }, style: { columns: 4, gap: 16 } },
    { id: "popular-auctions", label: "Popular Auctions", enabled: true, published: true, order: 7, visibility: { desktop: true, tablet: true, mobile: true }, style: { gap: 12 } },
    { id: "business-spotlight", label: "Business Spotlight", enabled: true, published: true, order: 8, visibility: { desktop: true, tablet: true, mobile: true }, style: { gap: 16 } },
    { id: "continue-browsing", label: "Continue Browsing", enabled: true, published: true, order: 9, visibility: { desktop: true, tablet: true, mobile: true }, style: { gap: 16 } },
    { id: "footer", label: "Footer", enabled: false, published: false, order: 10, visibility: { desktop: true, tablet: true, mobile: false }, style: { padding: 24 } },
    { id: "bottom-navigation", label: "Bottom Navigation", enabled: true, published: true, order: 11, visibility: { desktop: false, tablet: true, mobile: true }, style: { height: 72 } },
  ];
