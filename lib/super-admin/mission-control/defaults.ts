...
export function createDefaultHomepageBuilderConfig(): HomepageBuilderConfig {
  const components: HomepageBuilderConfig["components"] = [
    ...
    { id: "featured-listings", label: "Featured Listings", enabled: true, published: true, order: 6, visibility: { desktop: true, tablet: true, mobile: true }, style: { columns: 5, gap: 16 } },
