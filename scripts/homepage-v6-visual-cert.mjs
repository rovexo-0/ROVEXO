#!/usr/bin/env node
/**
 * Homepage v6.0 visual certification — multi-viewport screenshots.
 */
...
const outDir = join(process.cwd(), "reports", "module-1", "homepage-v6");
...
async function main() {
  ...
  for (const vp of VIEWPORTS) {
    ...
    await page.locator('[data-homepage-version="v6.0"]').waitFor({ timeout: 30_000 });
  ...
  console.log(`Homepage v6 screenshots: ${outDir}`);
  await browser.close();
}
