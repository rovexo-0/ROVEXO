...
const module2Signals = [
  ...
  { id: "theme-light-only", pass: !existsSync("features/settings/components/AppearancePicker.tsx") && read("app/(platform)/layout.tsx").includes('data-theme="light"') && !read("styles/tokens.css").includes('[data-theme="dark"]') },
