...
const OPTIONAL_SPECS: EnvSpec[] = [
  ...
  {
    key: "PARCEL2GO_CLIENT_ID",
    group: "Shipping (Parcel2Go)",
    required: false,
    secret: true,
    example: "<client-id>",
    description: "Server-side only. Parcel2Go OAuth client ID for the ROVEXO shipping engine.",
  },
  {
    key: "PARCEL2GO_CLIENT_SECRET",
    group: "Shipping (Parcel2Go)",
    required: false,
    secret: true,
    example: "<client-secret>",
    description: "Server-side only. Parcel2Go OAuth client secret. Never expose to the frontend.",
  },
  {
    key: "PARCEL2GO_AUTH_URL",
    group: "Shipping (Parcel2Go)",
    required: false,
    example: "https://sandbox.parcel2go.com/auth",
    description: "Parcel2Go OAuth base URL (sandbox or live).",
  },
  {
    key: "PARCEL2GO_API_URL",
    group: "Shipping (Parcel2Go)",
    required: false,
    example: "https://sandbox.parcel2go.com",
    description: "Parcel2Go API base URL (sandbox or live).",
  },
  {
    key: "PARCEL2GO_WEBHOOK_SECRET",
    group: "Shipping (Parcel2Go)",
    required: false,
    secret: true,
    example: "<secure-random-string>",
    description: "Optional Parcel2Go webhook signing secret.",
  },
  {
