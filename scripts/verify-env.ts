...
const OPTIONAL_SPECS: EnvSpec[] = [
  ...
  },
  {
    ...
    group: "Shipping (Sendcloud)",
    required: false,
    secret: true,
    example: "<public-key>",
    description: "Server-side only. Sendcloud public API key for live carrier quotes and labels.",
  },
  {
    ...
    secret: true,
    example: "<secret-key>",
    description: "Server-side only. Sendcloud secret API key. Never expose to the frontend.",
  },
  {
    key: "SENDCLOUD_BASE_URL",
    group: "Shipping (Sendcloud)",
    required: false,
    example: "https://panel.sendcloud.sc/api/v2",
    description: "Optional Sendcloud API base URL override.",
  },
  {
    ...
    secret: true,
    example: "<secure-random-string>",
    description: "Optional Sendcloud webhook signing secret.",
  },
  {
