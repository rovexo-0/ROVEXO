...
describe("Seller Performance v1.0 — CANONICAL FREEZE", () => {
  ...
  it("locks seller dashboard sections for Absolute Final Master Menu", () => {
    ...
    expect(dashboard).toContain("Track your progress and unlock badges as you grow.");
    expect(dashboard).toContain("Performance Factors");
    expect(dashboard).toContain("Score Trend");
    expect(dashboard).toContain("Badges & Achievements");
    expect(dashboard).toContain("Earned");
    expect(dashboard).toContain("In Progress");
    expect(dashboard).toContain("Locked");
    expect(dashboard).toContain("SellerPerformanceHistorySection");
